    ...
    return (
        <Layout title="Products">
            ...
            <div className="flex justify-center w-full flex-col items-center text-center">
                ...
                <p className="px-8">熟語を作成して消去することができるパズルゲーム．動かし方、消え方は完全にぷよぷよ。名前はテトリス。連鎖や3文字以上の熟語を作成することで高得点を獲得できる．ちなみに消去できる最長文字列は独立行政法人等個人情報保護法。</p>
                ...
                <p className="px-8">価格帯や料理ジャンル、地域を入力するとDBから1つだけランダムにレストランを選択するアプリ。全然知らないお店を発見できたり、現在地からの検索もできたりと割と便利。</p>
                ...
                <div className="px-8 space-x-40 flex flex-wrap justify-center items-center">
                    <Image className="box-boder border-2" src="/gurunabi1.png" width='225' height="150" objectFit="contain"/>
                    <Image className="box-boder border-2" src="/gurunabi2.png" width='225' height="150" objectFit="contain"/>
                    <Image className="box-boder border-2" src="/gurunabi3.png" width='225' height="150" objectFit="contain"/>
                </div>
                <h4 className="pt-4">開発言語</h4>
                <p>TypeScript, React, Python, Flask</p>
                <h3 className="text-xl pt-16 pb-4">Wordcloud可視化アプリ</h3>

                <p className="px-8">Wordcloud上の単語をクリックすることで、その単語がどのような文章で出現しているのかを可視化するアプリ</p>
