...
const Portfolio: React.FC = () => {
    return (
        <Layout title="Portfolio">
            ...
            <p className="pt-4 px-8 xl, lg, md:px-0">香川県生まれ香川県育ちの二十二歳．<br />自然言語処理の応用について研究しており，研究テーマは，「機械学習を用いたTwitterユーザの居住地推定」。<br />現在は、ツイート内容からのみだけでなく天気情報などを利用して居住地を推定する方法について研究中</p>
